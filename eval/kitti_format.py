...
def createNVOutput():
    val_image_ids = _read_imageset_file('/root/xiaohu/OpenPCDet/cpp/point_pillars_kitti/eval/val.txt')
    for image_i in val_image_ids:
        str_i = str(image_i).zfill(6)

        calib_path = '/root/xiaohu/OpenPCDet/cpp/point_pillars_kitti/eval/kitti/object/training/calib/' + str_i + '.txt'
        image_2_path = '/root/xiaohu/OpenPCDet/cpp/point_pillars_kitti/eval/kitti/object/training/image_2/' + str_i + '.png'
        velo_det_path = '/root/xiaohu/OpenPCDet/cpp/point_pillars_kitti/eval/kitti/object/pre_kitti/fp16/' + str_i + '.txt'
        cam_det_path = '/root/xiaohu/OpenPCDet/cpp/point_pillars_kitti/eval/kitti/object/pred/fp16/' + str_i + '.txt'
...
def createPCDetOutput():
    with open("./pcdet.pkl", "rb") as f:
        ...
        for txt_i in range(0, len(dt_annos)):
            ...
            cam_det_path = './kitti/object/pcdet/' + frame['frame_id'] + '.txt'
            with open(cam_det_path, 'w') as the_file:
